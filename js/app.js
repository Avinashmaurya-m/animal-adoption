...
export function topBar(user, active) {
  ...
  return (
    ...
    '<a href="feed.html" class="brand" aria-label="RescueNest home"><img class="brand-logo" src="assets/rescuenest-logo.png" alt="RescueNest logo"><span>Rescue<span class="brand-accent">Nest</span></span></a>' +
